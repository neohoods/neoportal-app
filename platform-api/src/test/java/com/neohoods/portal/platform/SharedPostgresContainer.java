...
public class SharedPostgresContainer {
    ...
    private void executeInitScriptViaPsql(String databaseName, String scriptName) throws Exception {
        ...
        // Utiliser psql pour exécuter le script (plus fiable pour les fonctions et triggers)
    ...
    private File findScriptFile(String scriptName) {
        ...
        // Si aucun fichier trouvé, essayer le chemin absolu depuis le répertoire de travail
        String userDir = System.getProperty("user.dir");
        if (userDir != null) {
