#!/usr/bin/env python3
"""
Script pour générer des réservations réalistes avec des UUIDs valides
...
def generate_sql(reservations, access_codes, feedbacks):
    ...
    reservations_sql = "-- Sample Reservations (generated with realistic occupancy rates)\n"
    ...
    with open('/Users/qcastel/Development/GIT/github/neohoods/neoportal-app/new_generated_reservations.sql', 'w', encoding='utf-8') as f:
        f.write(reservations_sql)
        f.write(access_codes_sql)
        f.write(feedbacks_sql)
    
    print("SQL généré dans: new_generated_reservations.sql")

def main():
    """Fonction principale"""
    print("Génération des réservations avec UUIDs valides...")
